  ...
  const servicesData = {
    home: {
      ...
      features: ensureStringArray(
        t("serviceData.home.features", { returnObjects: true }) as
          | string[]
      ...
      pricing: [
        {
          ...
          features: ensureStringArray(
            t("serviceData.home.pricing.smallApartment.features", {
              returnObjects: true,
        ...
        },
        {
          ...
          unit: t("pricing.perCleaning"),
          features: ensureStringArray(
            t("serviceData.home.pricing.mediumApartment.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
        {
          ...
          features: ensureStringArray(
            t("serviceData.home.pricing.largeHouse.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
    ...
    office: {
      ...
      features: ensureStringArray(
        t("serviceData.office.features", { returnObjects: true }) as
          | string[]
          | Record<string, string>
      ),
      image:
      ...
      pricing: [
        {
          ...
          unit: t("pricing.perCleaning"),
          features: ensureStringArray(
            t("serviceData.office.pricing.smallOffices.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
        {
          ...
          unit: t("pricing.perCleaning"),
          features: ensureStringArray(
            t("serviceData.office.pricing.mediumOffices.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
        {
          ...
          unit: t("pricing.customPrice"),
          features: ensureStringArray(
            t("serviceData.office.pricing.largeOffices.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
      ...
      pricing: [
        {
          ...
          unit: t("pricing.perCleaning"),
          features: ensureStringArray(
            t("serviceData.airbnb.pricing.oneBedroom.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
        {
          ...
          unit: t("pricing.perCleaning"),
          features: ensureStringArray(
            t("serviceData.airbnb.pricing.twoThreeBedroom.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
        {
          ...
          unit: t("pricing.perCleaning"),
          features: ensureStringArray(
            t("serviceData.airbnb.pricing.largeApartments.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
    ...
    furniture: {
      ...
      features: ensureStringArray(
        t("serviceData.furniture.features", { returnObjects: true }) as
          | string[]
          | Record<string, string>
      ),
      image:
      ...
      pricing: [
        {
          ...
          unit: t("pricing.perCleaning"),
          features: ensureStringArray(
            t("serviceData.furniture.pricing.sofaCleaning.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
        {
          ...
          features: ensureStringArray(
            t("serviceData.furniture.pricing.carpetCleaning.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
    ...
    renovation: {
      ...
      features: ensureStringArray(
        t("serviceData.renovation.features", { returnObjects: true }) as
          | string[]
          | Record<string, string>
      ),
      image:
      ...
      pricing: [
        {
          ...
          unit: t("pricing.perSquareMeter"),
          features: ensureStringArray(
            t("serviceData.renovation.pricing.roughCleaning.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
        {
          ...
          unit: t("pricing.perSquareMeter"),
          features: ensureStringArray(
            t("serviceData.renovation.pricing.finalCleaning.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
    ...
    development: {
      ...
      features: ensureStringArray(
        t("serviceData.development.features", { returnObjects: true }) as
          | string[]
          | Record<string, string>
      ),
      image:
    ...
    buildings: {
      ...
      features: ensureStringArray(
        t("serviceData.buildings.features", { returnObjects: true }) as
          | string[]
          | Record<string, string>
      ),
      image:
      ...
      pricing: [
        {
          ...
          features: ensureStringArray(
            t("serviceData.buildings.pricing.smallBuilding.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
        {
          ...
          unit: t("pricing.monthly"),
          features: ensureStringArray(
            t("serviceData.buildings.pricing.mediumBuilding.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
        {
          ...
          unit: t("pricing.onRequest"),
          features: ensureStringArray(
            t("serviceData.buildings.pricing.largeBuilding.features", {
              returnObjects: true,
            }) as string[] | Record<string, string>
          ),
        },
